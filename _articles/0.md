...
Unfortunately, however, not much good news so far, as still ~50% of first marriages fail by 20 years of marriage according to these statistics (though it's important to note these statistics count disruption via death in the percentage).

But that's ok! We're not done yet.
...
Before we move on, I'd like to note one more major reason for divorce: financial problems, cited by 36% of divorcees. How does that go?
...
So now, let's cover income, education, and intelligence. I lump all three together since they are all correlated with each other.

The percentage of divorcees in the married-at-least-once population [levels off significantly](https://flowingdata.com/2021/05/04/divorce-rates-and-income/) as you approach $200,000 of household income. Past that, the data is a bit noisy and fluctuates like a sine wave (see link for visual).

Overall, it drops from ~40-45% with <20k in income to a mere 25-30% at the trough (around $200-500k).

Similarly, college education of the wife [significantly reduces](https://www.cdc.gov/nchs/data/nhsr/nhsr049.pdf) the chances of divorce, contrary to the claims of some people. According to the linked paper (Table 5), the chance of divorce after 20 years of marriage for women with bachelor's degrees is **only 22%** as compared to **61%** for high school dropouts, **59%** for high school graduates, and **51%** for college dropouts. How interesting!

And if that wasn't enough, more intelligent couples are much more likely to stay together. In a study from Finland, over five years **82%** of men with the lowest intelligence score who got married at 26-30 stayed married, whereas **94%** of men with the highest intelligence scores stayed married. In other words, the chance of divorcing over five years was **over 50% less** for the most intelligent men versus the least intelligent.

The score in this study was measured by what was essentially IQ (which also correlates with income and education), so I wouldn't add too much more stock to this. But it is important to take into account (e.g. if you're reading this article, you probably aren't in the lowest decile).

Of course, all of these are correlated, and I expect education at least is highly anti-correlated with substance abuse, domestic violence, and probably even infidelity. But if you check all the right boxes, your chances just decreased drastically regardless.

## <<< Half of *all* first-time marriages without abuse, cheating, or substance abuse, where both spouses are educated, smart, and have a high household income fail
...
Of course, I'm not saying that you have a 0% chance of divorcing even if your marriage ticks all of the right boxes. People change, love fades, sometimes sh\*t happens and it's nobody's fault in particular. But the chances of failure sure as hell aren't *50%*.

So why do people think they have a high chance of divorce even if they fall into none of the pits typical divorcees do? I suspect some people have a few horror stories in mind and extrapolate it to themselves faultily.

But I think a lot of this is just bad reasoning in general. People love to apply general population statistics to themselves, but averages are extremely bad to apply to yourself.
...
Or, would you consider first whether you live in a heavily wooded area to begin with? If you don't, your chances are near zero. If you *do*, your chances just increased drastically (even if they are still relatively small). The average will never capture the real chances in either scenario.

So, even this article is insufficient and will always be. The best we can do is find correlations. Assessing your own chances is going to depend heavily on who you marry. If you marry someone who you have nothing in common with even if you both check all the right boxes in the abstract, you may have a divorce coming at you quickly.

So, you can generally ignore general population statistics for your own decision-making. Whenever you see them, always ask yourself: "what *kind* of person would fall into this situation?" Then, adjust your expectations accordingly.
